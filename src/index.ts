...
import { worktreeLabel } from './worktree/label.ts'
...
export { classifyPath, isWithin, toAbsolute } from './routing/classify.ts'
export type { AnchorRoute, Route } from './routing/classify.ts'
export { createRoutingFileSystem } from './routing/fs.ts'
export type { FileSystemContract, RoutingFileSystemDeps } from './routing/fs.ts'
export { NodeRequestError } from './node/channel.ts'
...
export { createRepoStore, defaultRepoName } from './repos/store.ts'
export type { RepoDraft, RepoRecord, RepoRef, RepoStore } from './repos/store.ts'
export { handleNodeApi } from './web/api.ts'
export type { ApiRequest, ApiResponse, ManagementApiDeps } from './web/api.ts'
export { worktreeLabel } from './worktree/label.ts'
export type { WorktreeLabelParts } from './worktree/label.ts'
export { API_PREFIX, registerNodeApi } from './web/mount.ts'
